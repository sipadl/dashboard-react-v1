...
export default function TambahSound() {
  return (
    <div>
      <Breadcrumb before={"Manajemen Perangkat"} after={"Tambah Soundbox"} />
      <div className="mt-4 h2 text-halaman-detail">Tambah Soundbox</div>
      <div className="mt-5 h5 text-halaman-detail-small">Informasi Dasar</div>
      <small>Informasi dasar Soundbox</small>
